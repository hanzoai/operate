...
Operator 非常棒，但 Operator 无需邀请码即可实现任何创意 🛫！
...
用 Operator 开启你的智能体之旅吧！

我们也非常高兴地向大家介绍 [Operator-RL](https://github.com/Operator/Operator-RL)，这是一个专注于基于强化学习（RL，例如 GRPO）的方法来优化大语言模型（LLM）智能体的开源项目，由来自UIUC 和 Operator 的研究人员合作开发。
...
Operator 需要配置使用的 LLM API，请按以下步骤设置：
...
Operator 由 MetaGPT 社区的贡献者共同构建，感谢这个充满活力的智能体开发者社区！

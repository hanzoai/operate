...
Operator는 놀라운 도구지만, Operator는 *초대 코드* 없이도 모든 아이디어를 실현할 수 있습니다! 🛫
...
Operator를 통해 여러분만의 에이전트를 즐겨보세요!

또한 [Operator-RL](https://github.com/Operator/Operator-RL)을 소개하게 되어 기쁩니다. Operator와 UIUC 연구자들이 공동 개발한 이 오픈소스 프로젝트는 LLM 에이전트에 대해 강화 학습(RL) 기반 (예: GRPO) 튜닝 방법을 제공합니다.
...
Operator를 사용하려면 사용하는 LLM API에 대한 설정이 필요합니다. 아래 단계를 따라 설정을 완료하세요:
...
Operator는 MetaGPT 기여자들에 의해 개발되었습니다. 이 에이전트 커뮤니티에 깊은 감사를 전합니다!
